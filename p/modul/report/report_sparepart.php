                           ...
                           <div class='row'>
							...
							<div class='table-responsive'>
                                <table class='table table-striped table-hover dataTable js-exportable'>
									...
									echo "<br />";
									echo "Hasil = $kota2";
									$cari = "SELECT p.dateprob, s.username, m.idMesin, u.idUnit, t.idReq, t.idProb, t.nama_teknisi, t.kode_sparepart, t.mesin, t.unit,ta.nama_sparepart, t.qty, t.satuan, t.createdDate, ta.info, ta.createdBy as appBy, ta.createdDate as appDate
