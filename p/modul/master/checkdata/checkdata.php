                    ...
                    <div class="card">
						...
						<div class="table-responsive">
                                <table class="table table-hover js-basic-example dataTable table-custom m-b-0">
                                    ...
                                    <tbody>
									<?php
									$t = mysqli_query($conn, "SELECT * FROM tproblems order by idprob DESC");
									$i=1;
						...
						<button type='button' class='btn btn-primary' data-toggle='modal' data-target='#addhand'><i class='icon-plus'></i> Tambah Data</button><br><br>
                            <div class="table-responsive">
                                <table class="table table-hover js-basic-example dataTable table-custom m-b-0">
                                    ...
                                    <tbody>
									<?php
									$t = mysqli_query($conn, "SELECT * FROM thandling where idProb IS NOT NULL order by idHandling DESC");
									$i=1;
									while($r = mysqli_fetch_array($t)){
									?>
                                        <tr>
