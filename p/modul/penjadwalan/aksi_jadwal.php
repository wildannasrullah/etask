...
if($p=='todolist' AND $act=='finishtugas'){
	...
	$time_fin = mysqli_fetch_array(mysqli_query($conn, "select idProb, statusProblem, dateAction, handling from thandling where statusProblem = 'DIKERJAKAN' AND idProb = '$_GET[id]' "));
	...
	$start 		= date('Y-m-d')." 00:00:00";
	mysqli_query($conn,"UPDATE tpenjadwalan SET color='#0071c5', status_tugas='DIKERJAKAN', est_day = '$hari', est_hour = '$jam', est_min = '$menit'
							where kode_tugas='$_GET[id]' AND status_tugas='FINISH'");
